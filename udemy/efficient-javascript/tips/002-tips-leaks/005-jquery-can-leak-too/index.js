...
/*
    (1) elem[jQuery.expando] = ++jQuery.uuid;
    (2) jQuery.cache[elem[jQuery.expando]]['property'] = 'value';

    [ ✓ ] DOM can never reference JavaScript object directly.

    Corollary:
        Removing elements using native methods can leak.
 */
